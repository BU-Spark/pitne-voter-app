...
export default function BallotInfo() {
    ...
    return (
        ...
        <p className='text-xl font-semibold  p-10 bg-blue-200'>  Enter your address to find out your district. </p>
            {/* Address form */}
           ...
           <p className='text-xl  font-semibold  p-10 bg-blue-200'> Toggle between upcoming elections to explore your district's candidates.</p>
            ...
            <div className='flex flex-col justify-center items-center py-8 px-2 my-6'>
                ...
                <h1 className='font-bold text-center mx-6 my-4 text-4xl' style={{ fontFamily: 'Arial, sans-serif' }}><strong>What&apos;s on the Ballot?</strong></h1>
