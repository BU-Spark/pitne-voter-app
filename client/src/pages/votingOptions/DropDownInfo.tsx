    ...
    <>
      <Grid container spacing={2} style={{ paddingLeft: '24px', paddingRight: '24px' }}>
        <Grid item xs={12} sm={12} md={6} >
          {dropdownData_1.map((item, index) => (
              <Accordion key={index} className='bg-violet-100' style={{ marginBottom: '16px' }}>
                <AccordionSummary
